...
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic	// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
...
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous	// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
...
console.log(contactInfo);	console.log(contactInfo);
...
zooAnimals.forEach(function(items){
  return displayNames.push(`Name: ${items.animal_name} , ${items.scientific_name}`);
});

console.log(displayNames);	console.log(displayNames);
...
let lowPopulationAnimals = zooAnimals.filter(function(items){
...
let populationTotal = zooAnimals.reduce(function(accumulator, item){
  ...
  console.log(`I am the item: ${item.population}`);
